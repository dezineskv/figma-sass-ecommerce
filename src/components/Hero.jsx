    ...
    return (
      <>
        <div className="hero-outer container-gray background-gray-lt">
          <div
            className="row d-flex hero-inner background-gray-lt"
            style={{ maxWidth: "1440px", margin: "0 auto" }}
          >
            <div className="col-sm-1 col-md-6 text-left pt30 hero-expand">
              <div className="new-arrival">
                <img src="stars.png" alt="star" /> New Arrival{" "}
                <img src="stars.png" alt="star" />
              </div>
              <h4 className="hero-header primary-heading-h">
                Shop with Confidence: Trusted Source for Quality Products
              </h4>
              <p className="hero-text be-vietnam-pro-165-h">
