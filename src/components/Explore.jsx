                ...
                >
                  <div className="carousel-inner" role="listbox">
                    <div className="item active">
                      ...
                      <div className="carousel-caption">Explore More</div>
                    </div>
                  </div>
                </div>
              </Carousel.Item>{" "}
