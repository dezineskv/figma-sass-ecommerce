  ...
  return (
    <div style={{ width: "100%" }} className="outer-latest background-gray-med">
      ...
      <div className="row d-flex justify-content-space-between cards-latest background-gray-med">
        <div
          className="col-sm-1 text-left img-top-left-latest rounded-3 top-0 start-0 p-2"
          style={{
            position: "relative",
            height: "390px",
            width: "450px",
        ...
        >
          <div className="row absolute-top-latest">
            <div className="col">
              ...
              <p>
                <img src="latest/arrow.png" className="arrow" alt="arrow" />
              </p>
        ...
        <div
          className="col-sm-1 text-left img-top-middle-latest rounded-3 top-0 start-0 p-2"
          style={{
            position: "relative",
            height: "390px",
            width: "450px",
        ...
        <div
          className="col-sm-1 text-left img-top-right-latest rounded-3 top-0 start-0 p-2"
          style={{
            position: "relative",
            height: "390px",
            width: "450px",
      ...
      <div className="row d-flex flex-direction: row justify-content-space-between cards-latest">
        <div
          className="col-sm-1 text-left img-bottom-left-latest rounded-3 top-0 start-0 p-2"
        ...
        >
          <div className="row absolute-bottom-l-latest cont-width">
            <div className="col cont-width" style={{ width: "50%" }}>
              ...
              <p className="cont-width be-vietnam-pro-146wb text-b">
                Dress up in summer vibe
              </p>
              <p className="cont-width be-vietnam-pro-slb">UPTO 50% OFF</p>
              <p className="cont-width">
                <img src="latest/arrow-b.png" className="arrow" alt="arrow" />
              </p>
              <div className="two-col">
                <div className="btn-l pt-20">
                  <Link to="/shop">
                    <button className="btn-primary-lb" type="button" >
                      Shop Now
                    </button>
                  </Link>
                </div>
        ...
        <div
          className="col-sm-1 text-left img-bottom-right-latest rounded-3 top-0 start-0 p-2"
          style={{ position: "relative", marginBottom: "2rem" }}
        >
